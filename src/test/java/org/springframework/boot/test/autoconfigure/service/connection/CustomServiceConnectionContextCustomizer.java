 ...
 * @author Phillip Webb
 */
public class CustomServiceConnectionContextCustomizer implements ContextCustomizer {
	...
	CustomServiceConnectionContextCustomizer(List<ContainerConnectionSource<?, ?, ?>> sources) {
